...
Silicon vendors provide their ARM-Cortex system in CMSIS standard by adding the device specific startup code and system configuration code. In our case, ST packs them in STM32CubeF0 which can be accessed in this github repository:

[STM32CubeF0 GitHub repository](https://github.com/STMicroelectronics/STM32CubeF0)
...
A clone of STM32CubeF0 repository should be stored in the workspace:
```
...
Content of the `create_stm32f0_project` script is below:


<script src="https://gist.github.com/sergunay/17291d7e3085b76145b9815eeeb97d9e.js"></script>
...
`uart2_write` function sends the string characters one by one:
...
In this post, I have shared my experiments of bare-metal programming of a STM32G0 board.
Although it is not a short post, it is of course impossible to cover all the details.
