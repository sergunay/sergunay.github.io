...
In addition to this, they apply an abstraction by using high-level libraries and OS integration.
...
I will use a minimum set of documents, tools and source codes which are all open source and free.
...
The necessary reference documents are placed in `stm32/f0/doc` directory.
...
Vendors, keeps the structure, standardized definitions of the core registers, bit position naming etc. and adds their device specific information such as peripheral addresses and interrupt vector table. 
