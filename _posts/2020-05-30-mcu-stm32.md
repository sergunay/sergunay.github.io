...
There are many software tools to develop microcontroller projects such as STM32 CubeMX, TI Code Composer Studio, Keil MDK, etc.
They provide GUI interface to initialize the code, build and debug the application.
In addition to this, they applies an abstraction to the register level by using high-level libraries and OS integration.
All this makes learning curve steep, enables fast initial development and allows a better portability in the same vendor devices.

However this abstraction prevents to learn how it actually works and bring vendor dependency.
Including ...
optimization ...
And even worse, they may need a paid license.
