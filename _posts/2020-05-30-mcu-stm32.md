...
While OpenOCD is running as a server on the PC, GDB can connect to the MCU from on a port specified by the openocd configuration file.
TODO: find the corresponding line. 3333
