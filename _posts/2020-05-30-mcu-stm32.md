...
Low-level programming by accessing registers, using the toolchain by a Makefile, debugging with gdb and a good text editor provide a very powerful development environment at no cost.
In this bare-metal programming, any abstraction is not used and direct access to the MCU registers is made.
This brings better control on the implementation and better comprehension onto the process.
